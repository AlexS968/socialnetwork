...
INSERT INTO country (id, title) VALUES (239, " ");
INSERT INTO city (id, country_id, title) VALUES (5471206, 239 , " ");
...
INSERT INTO `person` (
    ...
    city_id, country_id)
    VALUES
    (1, "about", "2020-10-22", "referer", "user@user.ru", "testUser",
    ...
    (2, "about", "2010-10-22", "", "user01@user.ru", "testUser01",
    "111-222-4444", 1, 0, "LastName01", NOW(), "ALL", "$2a$10$CogjAlX0O78H9AbuJDsBMuExLksckVOlx/Y9b/8Gv0FDS0Tjd2zna",
    "/static/img/default_avatar.png", NOW(), 1, 1),
    (3, "about", "2008-10-22", "", "user02@user.ru", "Иван",
    "111-222-4444", 1, 0, "LastName01", NOW(), "ALL", "$2a$10$CogjAlX0O78H9AbuJDsBMuExLksckVOlx/Y9b/8Gv0FDS0Tjd2zna",
    "/static/img/default_avatar.png", NOW(), 1, 1),
    (4, "about", "2009-10-22", "", "user03@user.ru", "Иван",
    "111-222-4444", 1, 0, "LastName01", NOW(), "ALL", "$2a$10$CogjAlX0O78H9AbuJDsBMuExLksckVOlx/Y9b/8Gv0FDS0Tjd2zna",
    "/static/img/default_avatar.png", NOW(), 1, 1);
